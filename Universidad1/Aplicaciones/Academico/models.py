...
class Curso(models.Model):
    ...
    salon = models.CharField(max_length=10, null=True, blank=True)
    
    def __str__(self):
        texto = '{0} ({1}) / Docente: {2}'
        return texto.format(self.nombre, self.creditos, self.profesor)
...
class Matricula(models.Model):
    ...
    def __str__(self):
        ...
        return texto.format(self.estudiante.nombreCompleto(),letraSexo, self.curso, fecMat)
